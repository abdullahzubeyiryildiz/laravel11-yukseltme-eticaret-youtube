...
class PageController extends Controller
{
    ...
    public function urundetay($slug) {
           ...
           $category = Category::where('id',$product->category_id)->with('category')->first();
            ...
            if(!empty($category)) {
                $breadcrumb['sayfalar'][] = [
                    'link'=> route(!empty($category->cat_ust) ? $category->category->slug.'urunler' : $category->slug.'urunler'),
                    'name' => $category->name
                ];
            }
